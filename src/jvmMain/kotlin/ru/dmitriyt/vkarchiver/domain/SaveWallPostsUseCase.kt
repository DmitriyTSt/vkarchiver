...
class SaveWallPostsUseCase(
    ...
    suspend operator fun invoke(
        ...
        coroutineScope {
            val cacheResourcePosts = if (needCacheImages) {
                ...
                val cacheAsyncResourcePosts = posts.map { post ->
                    ...
                    post.copy(attachments = post.attachments.filter { it !is WallPostAttachment.Photo }) to asyncAttachments
                }
                ...
                posts.map { CachedWallPost(it, emptyList()) }
            }
